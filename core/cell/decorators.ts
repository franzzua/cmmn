...
export function cell<T, TClass = unknown>(options: ICellOptions<T> = {}): CellDecorator<TClass, T> {
        ...
        switch (context.kind) {
            ...
            case 'setter':
                ...
                return function (this: TClass, value: T) {
                    getOrCreateCell(this as never, context.name,
            ...
            case 'accessor':
                ...
                return {
                    get(this: TClass) {
                        return getOrCreateCell(this as never, context.name, () => createCell(this)).get();
                    },
                    set(this: TClass, value: T) {
                        return getOrCreateCell(this as never, context.name, () => createCell(this)).set(value);
                    },
